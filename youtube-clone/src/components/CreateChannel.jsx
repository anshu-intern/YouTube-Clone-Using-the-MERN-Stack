...
function CreateChannel({cancel , create}){
    ...
    function handelChannelNameValue(e){
        setChannelName(e.target.value);
    }

    function handleChannelHandleValue(e){
    ...
    return(
        ...
        <div className="relative bg-white shadow-2xl rounded-xl w-[100%] max-w-[750px] p-2">
            ...
            <div className=" relative flex flex-col justify-center items-center gap-4 w-[100%] md:px-36 py-10">
                ...
                <div className="relative w-[100%]">
                    <input id='channelusername' type='text' placeholder=" " className="peer border border-gray-300 rounded w-[100%] h-[50px] pt-6 px-2 pb-2" onChange={ e => handelChannelNameValue(e) }/>
                ...
                <div className="relative w-[100%]">
                    <input id='channelHandlename' value={channelHandle} type='text' placeholder=" " className="peer border border-gray-300 rounded w-[100%] h-[50px] pt-6 px-2 pb-2" onChange={ e => handleChannelHandleValue(e) }/>
            ...
            <div className="relative flex flex-row justify-end items-end gap-2 text-[14px]">
                <button className="px-4 py-2 rounded-3xl hover:bg-gray-200 cursor-pointer" onClick={cancel}>Cancel</button>
                <button className="px-4 py-2 rounded-3xl text-blue-600 hover:bg-blue-100 cursor-pointer" onClick={ () => create({channelName, channelHandle, channelPic})}>Create channel</button>
            </div>
        </div>
        </>
    )
