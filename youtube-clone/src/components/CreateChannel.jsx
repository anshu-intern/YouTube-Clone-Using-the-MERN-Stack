...
function CreateChannel(){
    return(
        <>
        <div className="relative bg-white border rounded-xl w-[100%] max-w-[750px] p-2">
            ...
            <div className="relative flex flex-row justify-end items-end gap-2 text-[14px]">
                <button className="px-4 py-2 rounded-3xl hover:bg-gray-200">Cancel</button>
                <button className="px-4 py-2 rounded-3xl text-blue-600 hover:bg-blue-100">Create channel</button>
            </div>
        </div>
        </>
    )
